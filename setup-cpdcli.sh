...
${BIN_DFIR}/oc create secret docker-registry ibm-entitlement-key --docker-server=cp.icr.io --docker-username=cp --docker-password=${IBM_ENTITLEMENT_KEY} -n ${OPERATOR_NAMESPACE}
